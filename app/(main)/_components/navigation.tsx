...
import { ChevronLeft, MenuIcon, Plus, PlusCircle, Settings, Trash } from "lucide-react";
    ...
    return (
        ...
        >
            ...
            <div 
                ...
                onClick={resetWidth}
                className="opacity-0 group-hover/sidebar:opactiy-100 transition cursor-ew-resize absolute h-full w-1 bg-primary/10 right-0 top-0"
            />
        </aside>
        <div
        ref={navbarRef}
